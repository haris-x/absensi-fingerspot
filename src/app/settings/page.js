...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-12 max-w-4xl pb-12">
      ...
      <div className="space-y-6">
        <div>
          <h2 className="text-3xl font-extrabold text-slate-800 tracking-tight flex items-center gap-3">
            ...
            <span>Pengaturan Alat & Database</span>
          </h2>
          <p className="text-sm text-slate-500 mt-1">
            Parameter koneksi ke database lokal tempat data mesin absensi disinkronisasikan.
          </p>
        </div>
      ...
      {/* Section 2: WhatsApp Bot Settings */}
      <div className="space-y-6">
        <div>
          <h2 className="text-3xl font-extrabold text-slate-800 tracking-tight flex items-center gap-3">
            <MessageSquare className="text-emerald-600" size={28} />
            <span>Integrasi & Pengaturan WhatsApp Bot</span>
          </h2>
          <p className="text-sm text-slate-500 mt-1">
            Konfigurasi otomatisasi pengiriman laporan absensi dan rekonsiliasi kasir.
          </p>
        </div>
